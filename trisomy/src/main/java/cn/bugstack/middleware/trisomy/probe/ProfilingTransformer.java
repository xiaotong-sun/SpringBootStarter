package cn.bugstack.middleware.trisomy.probe;

import cn.bugstack.middleware.trisomy.config.ProfilingFilter;
...
public class ProfilingTransformer implements ClassFileTransformer {
    ...
    private static void outputClazz(byte[] bytes, String className) {
        ...
        try {
            String pathName = "E:\\itstack\\git\\MiddlewareDesign\\trisomy\\target\\test-classes\\" + className + "trisomy.class";
